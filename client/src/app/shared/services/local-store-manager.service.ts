...
export class LocalStoreManager {
  ...
  public initializeStorageSyncListener() {
  ...
  public deinitializeStorageSyncListener() {
    window.removeEventListener('storage', this.sessionStorageTransferHandler, false);
    LocalStoreManager.syncListenerInitialized = false;
  }
  ...
  public getInitEvent(): Observable<unknown> {
